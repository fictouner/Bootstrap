...
[class*=" icon-"] {
  /*注意上面选择器中间的空格*/
  /*我们使用的名为fictouner的字体就是上面的@font-face的方式声明的*/
  font-family: fictouner;
  font-style: normal;
}
...
.btn-fictouner:hover,
.btn-fictouner:focus,
.btn-fictouner:active,
.btn-fictouner.active,
.open .dropdown-toggle.btn-fictouner {
  color: #ffffff;
  background-color: #E92322;
  border-color: #DB3B43;
}
...
.btn-fictouner.disabled,
.btn-fictouner[disabled],
fieldset[disabled] .btn-fictouner,
.btn-fictouner.disabled:hover,
.btn-fictouner[disabled]:hover,
fieldset[disabled] .btn-fictouner:hover,
.btn-fictouner.disabled:focus,
.btn-fictouner[disabled]:focus,
fieldset[disabled] .btn-fictouner:focus,
.btn-fictouner.disabled:active,
.btn-fictouner[disabled]:active,
fieldset[disabled] .btn-fictouner:active,
.btn-fictouner.disabled.active,
.btn-fictouner[disabled].active,
fieldset[disabled] .btn-fictouner.active {
  background-color: #E92322;
...
```html
<nav class="navbar navbar-fictouner navbar-static-top">
  <div class="container">
